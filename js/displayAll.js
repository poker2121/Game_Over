import { gameDetailsManager } from "./gamedetails.js";
import { dataManager } from "./getData.js";
...
function addCardListeners() {
  let cardGames = document.querySelectorAll(".card-game");
  for (let i = 0; i < cardGames.length; i++) {
    cardGames[i].addEventListener("click", function (e) {
      dataManager.getGameDetails(e.currentTarget.getAttribute("data-id"));
      gameDetailsManager.showDetails();
    });
  }
}
